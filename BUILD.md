Build and Package SlicerForLeadDBS
==============================

This document summarizes how to build and package SlicerForLeadDBS on Windows.

SlicerForLeadDBS is a custom Slicer application. Reading the [3D Slicer Developer Documentation](https://slicer.readthedocs.io/en/latest/developer_guide/index.html) may help answer additional questions.
...
* Setting up your git account:
    ...
    * If not already done, email `FirstName LastName <firstname.lastname@netstim.com>` to be granted access to
    the [netstim/SlicerForLeadDBS](https://github.com/netstim/SlicerForLeadDBS) repository.
...
mkdir W
cd /c/W
git clone https://github.com/netstim/SlicerForLeadDBS.git S
```
...
3. Open `C:\W\SR\SlicerForLeadDBS.sln`, select `Release` and build the project.
